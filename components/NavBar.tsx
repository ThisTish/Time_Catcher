	...
	return (
		<>
			<header className="flex justify-between items-center w-full py-9 fixed bg-opacity-80 backdrop-blur-sm z-50 shadow-md shadow-sky-400  bg-sky-300 px-3">
				<Link href={"/"}><h1 className="text-5xl font-sans tracking-tighter text-stone-300 bg-stone-900 p-5 rounded-md bg-opacity-55 relative">TimeCatcher</h1></Link>
				<Clock className="absolute top-2 -left-2 -z-10 size-14 text-stone-300"/>
